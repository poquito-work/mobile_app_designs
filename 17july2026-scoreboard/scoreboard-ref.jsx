...
function Scoreboard({
  ...
  const extendPanel = (
    <div className="pq-scroll" style={{ position: "absolute", inset: 0, overflowY: "auto", background: "#F9F2E4", display: "flex", justifyContent: "center" }}>
      <div style={{ width: 360, maxWidth: "100%", minHeight: "100%", display: "flex", flexDirection: "column", padding: "16px 22px 18px" }}>
        ...
        <div style={{ marginTop: 12, fontFamily: F, fontWeight: 700, fontSize: 26, letterSpacing: "0.02em", textTransform: "uppercase", color: "#37342B", lineHeight: 1.05 }}>Extend the Game</div>
        <div style={{ marginTop: 5, fontFamily: F, fontSize: 13, color: "#9A9385" }}>Set the house rules – blame them later</div>
